			...
			<Stack
				...
				<MotionBox
					...
					<Text
						...
						en Sistemas Computacionales en la Escuela Superior de Cómputo
						(ESCOM) del Instituto Politécnico Nacional (IPN). Apasionados por la
						inteligencia artificial y los mercados financieros, desarrollamos
						soluciones innovadoras que aporten valor al análisis de
						criptomonedas.
					</Text>
