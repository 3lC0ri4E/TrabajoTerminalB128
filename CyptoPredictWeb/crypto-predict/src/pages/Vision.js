			...
			<Stack
				...
				<MotionBox
					...
					<Text
						...
						herramientas experimentales que faciliten decisiones más informadas
					...
					<Text
						...
						lineHeight='1.8'
						maxW='800px'>
						A través de nuestro prototipo, aspiramos a abrir nuevas
						oportunidades para el análisis financiero digital y contribuir al
						futuro del bitcoin, facilitando la integración de tecnologías
						emergentes en la toma de decisiones estratégicas.
					</Text>
				</MotionBox>
